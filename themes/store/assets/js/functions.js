...
var Message = {};
Message.focusToInvalidFields = function (data) {
...
Message.resetFormData = function (data) {
    $('form').trigger('reset');
};
...
(function($){
	...
	$(document).on('click', '[data-toogle="updateCart"]', function(){
        $('.cartFormItem').trigger('submit');
        return false;
    });
